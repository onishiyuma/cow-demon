	...
	//-----------------------------------------
	{
		...
		for (auto collision : collisions)
		{
			...
			if (collision->IsHit(m_charaCon))
			{
				...
				{
					m_BossEnemyHP -= m_player->m_criticalATK;
				...
				{
					m_BossEnemyHP -= m_player->m_normalATK;
	...
	//-----------------------------------------	
	{
		...
		for (auto collision : collisions)
		{
			...
			if (collision->IsHit(m_charaCon))
			{
				...
				//敵のHPを減らす。
				m_BossEnemyHP -= m_player->m_skillATK;
	...
	//-----------------------------------------
	{
		...
		for (auto collision : collisions)
		{
			...
			if (collision->IsHit(m_charaCon))
			{
				...
				//敵のHPを減らす。
				m_BossEnemyHP -= m_player->m_tukuyomiATK;
