...
public:
	...
	void ProcessDownStateTransition() override;         //ダウン（死亡）
...
private:
	...
	const Vector3		m_stopMove = Vector3::Zero;                  //完全停止ベクトル
	...
	bool		m_isGameOverFlag = false;       //ゲームオーバーを通知するフラグ
};
